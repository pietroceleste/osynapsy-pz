<?php
namespace Osynapsy\Html\Bcl\FileBox\Action;
 ...
 */
class FileBoxUploadAction extends AbstractAction
{       
    protected $fieldName;    
    protected $uploadDir;
    ...
    {
        $this->getController()->js(sprintf("$('#%s').val('%s');", $this->fieldName, $fileName));
